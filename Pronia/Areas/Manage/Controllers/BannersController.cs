...
namespace Pronia.Areas.Manage.Controllers
{
	...
	public class BannersController : Controller
	{
        ...
        public IActionResult Delete(int? id)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath,  "assets", "images", "banner", banner.Image));
        ...
        public IActionResult Update(int? Id, CreateBannerVM cb)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath,  "assets", "images", "banner", exist.Image));
