...
namespace Pronia.Areas.Manage.Controllers
{
    ...
    public class ShippingAreaController : Controller
    {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath, "assets", "images", "shipping", sa.Icon));
        ...
        public IActionResult Update(int? Id, ShippingAreaVM sa)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath, "assets", "images", "shipping", exist.Icon));
