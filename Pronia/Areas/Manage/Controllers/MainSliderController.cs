...
namespace Pronia.Areas.Manage.Controllers
{
    ...
    public class MainSliderController : Controller
    {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath,  "assets", "images", "slider", ms.Image));
        ...
        public IActionResult Update(int? Id, CreateSliderVM cs)
        {
            ...
            DeleteFile.Delete(Path.Combine(_env.WebRootPath,  "assets", "images", "slider", exist.Image));
